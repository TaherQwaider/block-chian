        ...
        <div class="card card-success">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card mb-2">
                            ...
                            <div class="card-img-overlay d-flex flex-column justify-content-center">
                                <h5 class="card-title text-white mt-5 pt-2">Certificate Title</h5>
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card mb-2">
                            <img class="card-img-top" src="{{ asset('assets/dist/img/photo3.jpg') }}" alt="Dist Photo 3">
                            <div class="card-img-overlay">
                                <h5 class="card-title text-primary">Certificate Title</h5>
